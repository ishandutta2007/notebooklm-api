...
[installation guide](https://github.com/ishandutta2007/open-notebooklm/blob/main/docs/installation.md).
...
[CLI reference](https://github.com/ishandutta2007/open-notebooklm/blob/main/docs/cli-reference.md).
For application code, use the baseline below and, when available, the
[Python API guide](https://github.com/ishandutta2007/open-notebooklm/blob/main/docs/python-api.md).
