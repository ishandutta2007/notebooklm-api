...
curl -LO https://github.com/ishandutta2007/open-notebooklm/releases/latest/download/docker-compose.yml
curl -LO https://github.com/ishandutta2007/open-notebooklm/releases/latest/download/env.example
cp env.example .env
