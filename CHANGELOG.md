...
[#2162]: https://github.com/ishandutta2007/open-notebooklm/pull/2162
[#2252]: https://github.com/ishandutta2007/open-notebooklm/pull/2252
[#2254]: https://github.com/ishandutta2007/open-notebooklm/pull/2254
[#2260]: https://github.com/ishandutta2007/open-notebooklm/pull/2260
[#2268]: https://github.com/ishandutta2007/open-notebooklm/pull/2268
[#2269]: https://github.com/ishandutta2007/open-notebooklm/pull/2269
[#2277]: https://github.com/ishandutta2007/open-notebooklm/pull/2277
[#2280]: https://github.com/ishandutta2007/open-notebooklm/pull/2280
[#2281]: https://github.com/ishandutta2007/open-notebooklm/pull/2281
[#2282]: https://github.com/ishandutta2007/open-notebooklm/pull/2282
[#2286]: https://github.com/ishandutta2007/open-notebooklm/pull/2286
[#2291]: https://github.com/ishandutta2007/open-notebooklm/pull/2291
[#2294]: https://github.com/ishandutta2007/open-notebooklm/pull/2294
[#2296]: https://github.com/ishandutta2007/open-notebooklm/pull/2296
[#2299]: https://github.com/ishandutta2007/open-notebooklm/pull/2299
[#2300]: https://github.com/ishandutta2007/open-notebooklm/pull/2300
[#2304]: https://github.com/ishandutta2007/open-notebooklm/pull/2304
[#2305]: https://github.com/ishandutta2007/open-notebooklm/pull/2305
[#2306]: https://github.com/ishandutta2007/open-notebooklm/pull/2306
[#2307]: https://github.com/ishandutta2007/open-notebooklm/pull/2307
[#2308]: https://github.com/ishandutta2007/open-notebooklm/pull/2308
[#2313]: https://github.com/ishandutta2007/open-notebooklm/issues/2313
[#2330]: https://github.com/ishandutta2007/open-notebooklm/issues/2330
...
[#1346](https://github.com/ishandutta2007/open-notebooklm/issues/1346) umbrella):
...
- **MCP file upload now records and can verify a SHA-256 of the uploaded bytes.**
  ...
  ([#1889](https://github.com/ishandutta2007/open-notebooklm/issues/1889)).
- **MCP `await_upload` emits progress keepalives while it polls**, so an MCP host
  ...
  token) ([#1889](https://github.com/ishandutta2007/open-notebooklm/issues/1889)).
- **MCP remote `studio_download` returns the report / data-table body inline**
  ...
  ([#1911](https://github.com/ishandutta2007/open-notebooklm/issues/1911)).
- **`studio_status` reports `media_ready`, `studio_download` reports
  ...
  ([#1924](https://github.com/ishandutta2007/open-notebooklm/issues/1924)).
- **Deploy quick start for end users**: the shipped Compose defaults to the
  ...
  ([#1904](https://github.com/ishandutta2007/open-notebooklm/issues/1904)).
...
- **Experimental in-app upload widget (opt-in).** With
  ...
  ([#1891](https://github.com/ishandutta2007/open-notebooklm/issues/1891),
  [#1894](https://github.com/ishandutta2007/open-notebooklm/issues/1894))
- **`studio_download` `download_ready` now carries `filename` / `mime` /
  ...
  envelope. ([#1835](https://github.com/ishandutta2007/open-notebooklm/issues/1835))
- **Explicit per-state counts in the `source_wait` aggregate.** The wait
  ...
  ([#1834](https://github.com/ishandutta2007/open-notebooklm/issues/1834))
...
- **`AccountLimits.tier` — a correct account-tier signal, sourced from the
  ...
  stay gone. ([#1738](https://github.com/ishandutta2007/open-notebooklm/issues/1738))

- **Short-form video format** across the client, CLI, MCP, and REST
  ([#1805](https://github.com/ishandutta2007/open-notebooklm/issues/1805)). Video
  ...
  dropped ([#1805](https://github.com/ishandutta2007/open-notebooklm/issues/1805)
  follow-up).

- **MCP `source_add` gains in-channel bytes and add-and-wait modes**
  ([#1803](https://github.com/ishandutta2007/open-notebooklm/issues/1803),
  [#1807](https://github.com/ishandutta2007/open-notebooklm/issues/1807),
  [#1890](https://github.com/ishandutta2007/open-notebooklm/issues/1890)). Rather than
...
- **Compact roster mode for `source_list` and `studio_list`**
  ([#1806](https://github.com/ishandutta2007/open-notebooklm/issues/1806)) — a terser
  listing shape that fits more entries into an agent's context window.

- **MCP strict IDs-only mode + canonical-id echoes**
  ([#1808](https://github.com/ishandutta2007/open-notebooklm/issues/1808)). Opt into
...
- **Near-miss candidates on failed name lookups**
  ([#1787](https://github.com/ishandutta2007/open-notebooklm/issues/1787)). When a
...
- **Per-tier quota & limit reference (`docs/quota-limits.md`).** A new reference
  ...
  [#1825](https://github.com/ishandutta2007/open-notebooklm/issues/1825); cross-linked from
...
- **Sandboxed agents (Claude Cowork / headless).** Documented running
  ...
  ([#1856](https://github.com/ishandutta2007/open-notebooklm/issues/1856))
...
- **MCP: the standalone `studio_get_prompt` tool was folded into `studio_list`**
  ...
  is unchanged.
  ([#1896](https://github.com/ishandutta2007/open-notebooklm/issues/1896))
...
- **MCP research tools now accept the poll id under one name, `poll_task_id`.**
  ...
  ([#1789](https://github.com/ishandutta2007/open-notebooklm/issues/1789))
...
- **Self-hosted MCP OAuth: switching the served account no longer resets the client
  ...
  ([#1901](https://github.com/ishandutta2007/open-notebooklm/issues/1901)) builds on — without
  implementing it.
- **`source_add` now honors an explicit `title` for YouTube, Google Drive, and
  ...
  ([#1960](https://github.com/ishandutta2007/open-notebooklm/issues/1960)).
- **Fresh conversations are no longer reported as follow-ups.** A null-conversation
  ...
  before setting `AskResult.is_follow_up` ([#1973](https://github.com/ishandutta2007/open-notebooklm/issues/1973)).
- **MCP `source_add` bytes upload no longer defaults to a generic
  ...
  filename ([#1955](https://github.com/ishandutta2007/open-notebooklm/issues/1955)).
- **Research import is now idempotent.** Re-importing a completed research task
  ...
  ([#1961](https://github.com/ishandutta2007/open-notebooklm/issues/1961)).
- `chat.ask()` (and the `chat_ask` MCP tool / `AskResult`) now report
  ...
  `is_follow_up=False`
  ([#1965](https://github.com/ishandutta2007/open-notebooklm/issues/1965)).
- **A missing optional-dependency error now points at the right fix.** Reading a
  ...
  ([#1959](https://github.com/ishandutta2007/open-notebooklm/issues/1959)).
- **MCP `notebook_describe(include_metadata=true)` no longer reports a source
  ...
  ([#1919](https://github.com/ishandutta2007/open-notebooklm/issues/1919)).
- **MCP `research_import` is safe for unattended use.** The tool now imports via
  ...
  ([#1920](https://github.com/ishandutta2007/open-notebooklm/issues/1920))
- **`source_add` batch mode isolates a per-URL failure** instead of aborting the
  ...
  ([#1905](https://github.com/ishandutta2007/open-notebooklm/issues/1905)).
- **MCP `studio_generate` for interactive mind maps** now normalizes its payload
  ...
  ([#1908](https://github.com/ishandutta2007/open-notebooklm/issues/1908),
  [#1914](https://github.com/ishandutta2007/open-notebooklm/issues/1914)).
- **MCP `research_cancel` distinguishes an already-cancelled run** and surfaces
  the raw status code instead of a generic failure
  ([#1922](https://github.com/ishandutta2007/open-notebooklm/issues/1922)).
- **Content-sanity flags bot-challenge / WAF interstitial pages**, so a source
  ...
  ([#1929](https://github.com/ishandutta2007/open-notebooklm/issues/1929)).
- **`suggest_prompts` strips a leading list marker** from returned prompts, and
  `research_start` drops redundant ids from its result
  ([#1909](https://github.com/ishandutta2007/open-notebooklm/issues/1909)).
- **The MCP server warns at startup when the upload widget is enabled but
  ...
  ([#1915](https://github.com/ishandutta2007/open-notebooklm/issues/1915)).
- **RPC failures no longer leak the obfuscated method id or raw status code into
  ...
  ([#1921](https://github.com/ishandutta2007/open-notebooklm/issues/1921),
  [#1931](https://github.com/ishandutta2007/open-notebooklm/issues/1931))
- **A blank `FASTMCP_STATELESS_HTTP` no longer crash-loops the remote MCP server.**
  ...
  the server. ([#1898](https://github.com/ishandutta2007/open-notebooklm/issues/1898))
- **Upstream upload errors surface as a clean, redacted 4xx — not an opaque 500.**
  ...
  ([#1892](https://github.com/ishandutta2007/open-notebooklm/issues/1892))
- **Upload-only Drive file types auto-route to the file-upload path.** Adding a
  ...
  ([#1887](https://github.com/ishandutta2007/open-notebooklm/issues/1887),
  [#1885](https://github.com/ishandutta2007/open-notebooklm/issues/1885))
- **Loopback MCP HTTP transport rejects non-loopback `Host` headers.** The
  ...
  ([#1876](https://github.com/ishandutta2007/open-notebooklm/issues/1876))
- **Null-conversation chat asks are serialized with explicit follow-ups.**
  ...
  ([#1880](https://github.com/ishandutta2007/open-notebooklm/issues/1880))
- **Multi-source `source_wait` no longer polls O(N²).** Waiting on N sources took
  ...
  is bounded. ([#1882](https://github.com/ishandutta2007/open-notebooklm/issues/1882))
- **Raised the streamed chat-response size cap.** Long answers were truncated at
  ...
  through. ([#1852](https://github.com/ishandutta2007/open-notebooklm/issues/1852))
- **Aggregate retry deadline threaded through the RPC path; OAuth `fsync`
  ...
  ([#1881](https://github.com/ishandutta2007/open-notebooklm/issues/1881))
- **`studio_download` rejects an unknown `output_format` self-documentingly.** An
  ...
  ([#1833](https://github.com/ishandutta2007/open-notebooklm/issues/1833))
- **MCP source waits stay JSON-first.** `source_wait` output is emitted as
  ...
  ([#1830](https://github.com/ishandutta2007/open-notebooklm/issues/1830))
- **Deep-research null-start no longer leaks an internal method id.** A failed
  ...
  hidden. ([#1851](https://github.com/ishandutta2007/open-notebooklm/issues/1851))
- **REST server resource-limit hardening.** Several bounds were added to the
  ...
  request-body size caps ([#1846](https://github.com/ishandutta2007/open-notebooklm/issues/1846)),
  route-group backpressure to cap concurrent in-flight requests
  ([#1847](https://github.com/ishandutta2007/open-notebooklm/issues/1847)), a bounded fanout
  for multi-source waits ([#1844](https://github.com/ishandutta2007/open-notebooklm/issues/1844)),
  a shared suggest-surface map so the suggest routes don't each rebuild it
  ([#1843](https://github.com/ishandutta2007/open-notebooklm/issues/1843)), and
  `PendingRegistry.drop()` now removes the stale FIFO tuple so the pending queue
  can't leak entries ([#1879](https://github.com/ishandutta2007/open-notebooklm/issues/1879)).
  Diagnostics endpoints also stay live when auth is stale instead of failing with
  the guarded routes ([#1845](https://github.com/ishandutta2007/open-notebooklm/issues/1845)),
  and the account block is fetched with a single `GET_USER_SETTINGS` call instead of
  two ([#1862](https://github.com/ishandutta2007/open-notebooklm/issues/1862)).
- **Artifact-generation validation footguns** ([#1874]). Three input-validation
  ...
  ([#1874](https://github.com/ishandutta2007/open-notebooklm/issues/1874))
...
- **MCP source tools no longer swallow fatal errors or fan out unbounded.** The MCP
  ...
  is unchanged.
  ([#1871](https://github.com/ishandutta2007/open-notebooklm/issues/1871))
- **Direct-PDF-URL sources no longer show the raw URL as their title.** Adding a
  ...
  **exactly the source URL** (the server degradation — not a user-set title that
  ...
  title). ([#1850](https://github.com/ishandutta2007/open-notebooklm/issues/1850))
- **Drive-hosted PDFs no longer list as `google_spreadsheet`.** The backend
  ...
  ([#1832](https://github.com/ishandutta2007/open-notebooklm/issues/1832))
...
- **First-class human/mobile upload path in `upload_required`**
  ([#1801](https://github.com/ishandutta2007/open-notebooklm/issues/1801)). When a source
...
- **`server_info` and the profile probe report the resolved profile, not the
  raw active one** ([#1790](https://github.com/ishandutta2007/open-notebooklm/issues/1790)).
...
- **The loopback DNS-rebinding `Host` guard is no longer bypassed on a tokenless
  ...
  **and** authentication (bearer or OAuth) is configured — the
  ...
  ([#1935](https://github.com/ishandutta2007/open-notebooklm/issues/1935)).
...
- **`notebooklm notebook delete --json`** ([#1167](https://github.com/ishandutta2007/open-notebooklm/issues/1167)). `notebook delete` was the last delete command (and the only `list` / `create` / `metadata` sibling) without a JSON envelope — passing `--json` crashed with `No such option`. It now emits the typed success/cancel envelope, refuses to prompt in `--json` mode (requiring `--yes`, else a `VALIDATION_ERROR` envelope + exit `1`), and surfaces `context_cleared: true` when the deleted notebook was the active context ([#1193](https://github.com/ishandutta2007/open-notebooklm/pull/1193)).
- **`notebooklm skill install --dry-run` / `--no-clobber` / `--force`** ([#1109](https://github.com/ishandutta2007/open-notebooklm/pull/1109)). Project-scope installs now classify each target as create / up-to-date / overwrite. A target that would be overwritten with *different* content exits `1` and lists the conflicts unless `--force` (overwrite) or `--no-clobber` (skip differing, still create missing) is passed; `--dry-run` previews intended writes without touching disk. Writes go through an atomic temp-file + `os.replace` so a crash can't leave a partial `SKILL.md`. User scope keeps the historical always-overwrite behavior (the new flags error when paired with `--scope user`).
- **`GenerationStatus.is_removed` + `status="removed"`** ([#1168](https://github.com/ishandutta2007/open-notebooklm/issues/1168)). A delisted or quota-removed artifact now reports `status="removed"` (`is_removed=True`) instead of a synthesized `"failed"`, so callers can distinguish a transient list omission from a server-marked FAILED artifact. `is_failed` stays `False` for a removal; `is_rate_limited` still treats a quota-worded removal as retryable, and CLI exit behavior is unchanged ([#1195](https://github.com/ishandutta2007/open-notebooklm/pull/1195)).
- **Structured media-timeout diagnostics.** When an *accepted* media task (audio / video / cinematic-video / infographic / slide-deck) stays queued or running past the `--wait` / `wait_for_completion` budget, the artifact APIs now raise a typed timeout exception that preserves the last poll-status transition and media-not-ready metadata (also surfaced in `--json`) instead of a bare timeout ([#1094](https://github.com/ishandutta2007/open-notebooklm/issues/1094)).

### Changed

- **Media `--wait` default timeouts raised.** `generate audio --wait` now defaults to 1200 s ([#1140](https://github.com/ishandutta2007/open-notebooklm/pull/1140)) and the video / cinematic-video wait defaults were increased to match empirical generation durations ([#1088](https://github.com/ishandutta2007/open-notebooklm/pull/1088), [#1094](https://github.com/ishandutta2007/open-notebooklm/issues/1094)), so long generations no longer time out before the artifact is ready under default settings. `docs/` now documents the media wait budgets and the manual `artifact wait` recovery path.
- **`notebooklm doctor` exits `1` when any check fails** ([#1160](https://github.com/ishandutta2007/open-notebooklm/issues/1160)). It previously built `status: "fail"` entries but always exited `0`, so CI health checks, `set -e` scripts, and monitoring probes read a broken install as green. Overall health is now computed from the final check states (after any `--fix`) and the process exits `1` if any check still fails (warnings stay non-fatal). The exit happens after the payload/table is emitted, so machine-readable `--json` output is unaffected; `doctor` profile JSON errors are also now wrapped in the typed envelope ([#1179](https://github.com/ishandutta2007/open-notebooklm/pull/1179), [#1146](https://github.com/ishandutta2007/open-notebooklm/pull/1146)).
- **Post-parse CLI validation errors emit the typed JSON envelope under `--json`** ([ADR-0015](docs/adr/0015-json-envelope-contract-for-post-parse-click-exceptions.md)). `download` flag conflicts (`--force` + `--no-clobber`, `--latest` + `--earliest`, `--all` + `--artifact`), `generate` validation (cinematic `--format` / `--style` conflicts, invalid `--language` / `NOTEBOOKLM_HL`), `research wait --cited-only` without `--import-all`, and `ask --new` + `--conversation-id` now route through `{"error": true, "code": "VALIDATION_ERROR", ...}` on stdout and exit `1` under `--json`, instead of Click's parser bypassing the envelope to exit `2` with usage text on stderr. Text-mode behavior (usage text, exit `2`) is unchanged. Flagged under **Breaking changes** above for `--json` automation ([#1112](https://github.com/ishandutta2007/open-notebooklm/pull/1112), [#1115](https://github.com/ishandutta2007/open-notebooklm/pull/1115), [#1117](https://github.com/ishandutta2007/open-notebooklm/pull/1117)).

### Fixed

- **`notebooklm artifact delete <id> --json` now requires `--yes` before deleting** ([#1197](https://github.com/ishandutta2007/open-notebooklm/issues/1197)). Without `--yes`, the command emits the typed `VALIDATION_ERROR` envelope, includes `"deleted": false`, exits `1`, and leaves the artifact untouched, matching the other destructive delete commands.
- **HTML file uploads now fail client-side with a clear validation error** ([#1127](https://github.com/ishandutta2007/open-notebooklm/issues/1127)). `notebooklm source add ./article.html` and `client.sources.add_file(..., "article.html")` previously reached NotebookLM's upload endpoint as `text/html` and surfaced a cryptic upstream `400 Bad Request`. The upload pipeline now rejects `.html` / `.htm` / `.xhtml` / `.xht` / HTML MIME uploads before registering a source, with guidance to convert the page to `.txt`, `.md`, or `.pdf`.
- **`notebooklm source fulltext -o FILE` no longer silently overwrites existing files** ([#1173](https://github.com/ishandutta2007/open-notebooklm/issues/1173)). Existing output paths now auto-rename by default (`FILE` -> `FILE (2)`, etc.); pass `--force` to overwrite intentionally or `--no-clobber` to fail when the path already exists.
- **`sources.list()` raises on a malformed `GET_NOTEBOOK` response under strict-decode (the default)** ([#1159](https://github.com/ishandutta2007/open-notebooklm/issues/1159)). A drifted or error-enveloped response was previously folded into an empty list, so a sync script could conclude every source had vanished and re-add them all. The hand-rolled list-shape checks now honor `NOTEBOOKLM_STRICT_DECODE` (logging the drift warning, then raising `RPCError`); a genuinely empty notebook (a `None` sources slot) still returns `[]`. Set `NOTEBOOKLM_STRICT_DECODE=0` for the legacy warn-and-return-`[]` fallback ([#1178](https://github.com/ishandutta2007/open-notebooklm/pull/1178)).
- **`client.rpc_call(..., allow_null=True)` raises on method-ID drift and anti-bot walls** ([#1158](https://github.com/ishandutta2007/open-notebooklm/issues/1158)). The decoder gated its entire null-handling block behind `not allow_null`, so opt-in null callers (`CREATE_ARTIFACT`, `GENERATE_MIND_MAP`, `DELETE_SOURCE`, `GET_SUGGESTED_REPORTS`, …) silently received `None` when Google rotated a method ID or served a redirect / anti-bot page. An absent RPC ID (drift) and a body with no RPC frames (anti-bot wall) now always raise; only a present-but-`null` `wrb.fr` frame returns `None`. Null-result error messages now embed the discovered `found_ids` ([#1176](https://github.com/ishandutta2007/open-notebooklm/pull/1176)).
- **Auth-refresh replay no longer re-issues non-idempotent writes** ([#1157](https://github.com/ishandutta2007/open-notebooklm/issues/1157)). After a mid-flight auth error (HTTP 401/403, or an auth-shaped decoded `RPCError`) on a probe-then-create method (`CREATE_NOTEBOOK`, `CREATE_ARTIFACT`, `CREATE_NOTE`, `ADD_SOURCE`, `SHARE_NOTEBOOK`, `GENERATE_MIND_MAP`), the refresh-and-retry path could duplicate the resource, invite email, or generation quota when the error landed *after* the server committed the write. Both replay paths (the `AuthRefreshMiddleware` 401/403 leg and the `RpcExecutor` decode-time leg) now honor the effective `disable_internal_retries` classification and propagate the original auth error so the caller's probe-then-create wrapper can disambiguate a commit-lost write ([#1177](https://github.com/ishandutta2007/open-notebooklm/pull/1177)).
- **`client.notes.create` raises when `CREATE_NOTE` returns no usable note id** ([#1162](https://github.com/ishandutta2007/open-notebooklm/issues/1162)). It previously fell through to a success-shaped `Note(id="")` that was never finalized via `UPDATE_NOTE` or persisted server-side, so any later operation keyed on the empty id silently misbehaved. It now raises `RPCError`, matching the sibling `add_source` / `notebooks.create` paths ([#1186](https://github.com/ishandutta2007/open-notebooklm/pull/1186)).
- **Stale authed-POST envelope rebuilt after a `401 → refresh → 429 → retry` flow** ([#1096](https://github.com/ishandutta2007/open-notebooklm/pull/1096)). The terminal freshness guard's snapshot-equality short-circuit could POST the pre-refresh URL / headers / body against the refreshed cookie jar; the envelope is now rebuilt from a freshly captured auth snapshot on every terminal attempt (byte-identical on the happy path, load-bearing on the post-refresh retry).
- **`NotebookLMClient.close(drain=True)` no longer hangs on in-flight artifact polls** ([#1161](https://github.com/ishandutta2007/open-notebooklm/issues/1161)). Registered drain hooks (which cancel polls parked in `operation_scope`) now fire before the drain wait, so `close()` short-circuits a pending poll instead of blocking up to the poll's own 300 s timeout ([#1182](https://github.com/ishandutta2007/open-notebooklm/pull/1182)).
- **`Kernel.open()` closes the httpx client if the open-time cookie snapshot raises** ([#1163](https://github.com/ishandutta2007/open-notebooklm/issues/1163)). A failure while capturing the open snapshot previously propagated with a live, never-closed client (Python skips `__aexit__` after a failed `__aenter__`), leaking the connection pool. `open()` now `aclose()`s the partial client and resets it so a retry rebuilds cleanly ([#1187](https://github.com/ishandutta2007/open-notebooklm/pull/1187)).
- **RPC concurrency semaphore gains the loop-affinity guard + close→reopen reset its siblings already have** ([#1169](https://github.com/ishandutta2007/open-notebooklm/issues/1169)). The per-client `max_concurrent_rpcs` semaphore was the only loop-bound primitive without an affinity guard or reset, so reopening a capped client on a different event loop reused the stale semaphore and could raise "bound to a different event loop" or mispark waiters on Python 3.10/3.11 (masked on 3.12+). It is now guarded by the bound-loop assertion and discarded on any bound-loop change ([#1196](https://github.com/ishandutta2007/open-notebooklm/pull/1196)).
- **New conversations are serialized per notebook** ([#1144](https://github.com/ishandutta2007/open-notebooklm/pull/1144)). Concurrent `chat.ask()` calls with no `conversation_id` against the same notebook are serialized so they no longer race to create duplicate server-side conversations.
- **Auth-refresh lock released if the lock-wait metric raises** ([#1164](https://github.com/ishandutta2007/open-notebooklm/issues/1164)). `await_refresh` recorded the lock-wait metric between `acquire()` and the `try`, so a metric-side exception left the auth-refresh lock held forever, deadlocking every subsequent refresh. The metric call moved inside the `try` / `finally: release()`, matching the sibling `update_auth_tokens` ([#1188](https://github.com/ishandutta2007/open-notebooklm/pull/1188)).
- **Source-upload registration fails closed on an unparseable source id** ([#1143](https://github.com/ishandutta2007/open-notebooklm/pull/1143)). The resumable-upload path now raises instead of silently accepting a response it can't parse a source id from, while still tolerating the legacy filename-first row shapes.
- **Artifact-generation defaults and null responses hardened** ([#1063](https://github.com/ishandutta2007/open-notebooklm/issues/1063), [#1088](https://github.com/ishandutta2007/open-notebooklm/pull/1088)). Omitting infographic options on the Python `client.artifacts.generate_*` calls now sends concrete visual defaults (matching the CLI) instead of producing a null `CREATE_ARTIFACT` result, and a null artifact-generation response is now classified as `ArtifactFeatureUnavailableError`.
- **`source` command `--json` output shape corrected and stabilized** ([#1129](https://github.com/ishandutta2007/open-notebooklm/pull/1129)). `source get --json` previously leaked the Python enum repr (`"type": "SourceType.URL"`) and now emits the bare kind value (`"type": "url"`); `source fulltext --json` now emits a fixed `{source_id, title, kind, content, url, char_count}` payload instead of a raw `asdict(SourceFulltext)` dump, and its `-o` envelope gains a `kind` field. **`--json` consumers that parsed `source get`'s `type` field or relied on extra `fulltext` keys must update** (flagged under **Breaking changes** above). Shared serializers keep the shape consistent across the source subcommands going forward.
...
- **`notebooklm agent show` routes errors to stderr** ([#1175](https://github.com/ishandutta2007/open-notebooklm/issues/1175)) so they no longer pollute stdout.
- **Auth-error classification hardened** ([#1142](https://github.com/ishandutta2007/open-notebooklm/pull/1142)) — empty RPC code labels no longer slip past the auth-error matcher.
- **Malformed `batchexecute` chunk records are now counted** ([#1141](https://github.com/ishandutta2007/open-notebooklm/pull/1141)) rather than silently dropped, so the `client.metrics` surface reflects partial-response drift.
...
- **SSRF guard on `source add --url`** ([#1114](https://github.com/ishandutta2007/open-notebooklm/pull/1114)). The prefix-only `startswith(("http://", "https://"))` check was replaced with a structural `urlsplit` parse + scheme allowlist (`http` / `https` only) plus a private / loopback / link-local IP guard and a `localhost`-literal guard. **Behavior change:** `http://localhost`, `http://127.0.0.1`, RFC-1918 hosts, and `http://169.254.169.254` are now rejected by default — pass the new `--allow-internal` flag to ingest an internal URL intentionally (the scheme allowlist still applies). DNS is never resolved at validation time. Flagged under **Breaking changes** above.
- **Resumable upload URLs validated and redacted** ([#1130](https://github.com/ishandutta2007/open-notebooklm/pull/1130)). The server-returned upload session / cancel URLs are validated before use and redacted in error and log output so a credentialed upload URL can't leak.
- **Artifact download allowlist validated by hostname** ([#1172](https://github.com/ishandutta2007/open-notebooklm/issues/1172)). Download host-allowlisting now parses the URL hostname structurally instead of matching a string prefix, closing a bypass where a crafted URL (including encoded-slash hosts, hardened further in [#1199](https://github.com/ishandutta2007/open-notebooklm/pull/1199)) could satisfy a prefix check while pointing at an untrusted host.
- **`httpx` / `urllib3` logs redacted for library consumers** ([#1166](https://github.com/ishandutta2007/open-notebooklm/issues/1166)). `configure_logging()` now attaches a logger-level `RedactingFilter` to the `httpx` and `urllib3` loggers at import, so a consumer who enables httpx DEBUG (e.g. `logging.basicConfig(level=logging.DEBUG)`) no longer sees the session id in `?f.sid=...` request lines. Pure defense-in-depth — no handler is added, so consumers who never enable those loggers see no behavior change ([#1191](https://github.com/ishandutta2007/open-notebooklm/pull/1191)).
- **Bare CSRF / session-id token values redacted in logs** ([#1165](https://github.com/ishandutta2007/open-notebooklm/issues/1165)). The scrubber now redacts bare `SNlM0e` (CSRF) and `FdrFJe` (session-id) `WIZ_global_data` markers, the `csrf=` form alias, and standalone `AF1_QpN-` CSRF tokens — credential-equivalent shapes that previously passed through `scrub_secrets()` unredacted ([#1189](https://github.com/ishandutta2007/open-notebooklm/pull/1189)).
- **Playwright login subprocess output sanitized** ([#1111](https://github.com/ishandutta2007/open-notebooklm/pull/1111)). `ensure_chromium_installed` now strips ANSI control sequences and redacts inherited environment-variable secret values (including JSON-nested leaves such as `NOTEBOOKLM_AUTH_JSON`) from captured subprocess stderr/stdout before surfacing install diagnostics (meta-audit G4).
...
- **In-memory `__Secure-1PSIDTS` recovery during `--browser-cookies` extraction** ([#990](https://github.com/ishandutta2007/open-notebooklm/pull/990), [#991](https://github.com/ishandutta2007/open-notebooklm/pull/991)). When `rookiepy` returns a partial cookie set (most often when the browser hasn't rotated `__Secure-1PSIDTS` yet), a single `RotateCookies` POST against the live browser cookies mints the missing token before persistence. Recovery declines surface scenario-specific hints (`No SID → "You are not signed in to Google in <browser>"`, `PSIDTS missing + secondary binding intact → "RotateCookies recovery did not succeed. Open https://notebooklm.google.com in <browser>"`) instead of the previous generic "No valid Google authentication cookies found".
...
- **`chat save` preserves inline citation hover anchors** (closes #660, [#675](https://github.com/ishandutta2007/open-notebooklm/pull/675)). Saved notes retain `[citation]`-style anchors so users can hover-preview the source passage that grounded each claim in the NotebookLM web UI.
...
- **`ResearchAPI.wait_for_completion(notebook_id, task_id=None, *, timeout=1800, interval=5)`** ([#970](https://github.com/ishandutta2007/open-notebooklm/pull/970)). Polls until research reaches a terminal state (`completed` / `failed`) or the timeout fires; passes through `task_id` on subsequent polls once the backend assigns one to prevent a later concurrent task from substituting its sources/report. Surfaces a new terminal `failed` status so wait loops no longer spin until timeout after the backend rejects a task.
- **`notebooklm.artifacts.with_rate_limit_retry(callable, *, max_retries=3, ...)`** ([#969](https://github.com/ishandutta2007/open-notebooklm/pull/969)). Shared retry helper for the `client.artifacts.generate_*` family — catches generation-time `RateLimitError`, honors `retry_after`, and falls back to exponential backoff. Replaces the per-caller try/except/sleep boilerplate previously suggested in `docs/python-api.md`.
- **`__all__` declared on `notebooklm.paths`, `notebooklm.migration`, and `notebooklm.notebooklm_cli`** ([#958](https://github.com/ishandutta2007/open-notebooklm/pull/958)). ADR-0012 marks all three as public modules; `__all__` now pins the exported surface (12 names on `paths`, 3 on `migration`, `cli` + `main` on the CLI entry point) so `from notebooklm.paths import *` is well-defined and the public API compatibility audit can lock it.

### Changed
- **Custom `--storage` downloads now use the selected auth file** ([#838](https://github.com/ishandutta2007/open-notebooklm/issues/838), [#888](https://github.com/ishandutta2007/open-notebooklm/pull/888)). `ArtifactDownloadService` previously snapshotted the session's storage path at construction time, so `--storage` overrides applied after construction were silently ignored on download. CLI `--storage` flag and mid-process profile switches are now inherited reliably.
...
- **Source upload auth/MIME routing** ([#984](https://github.com/ishandutta2007/open-notebooklm/pull/984)). The resumable-upload path skipped a redundant env-auth lookup and now classifies media MIME types case-insensitively; `application/mp4` is included in the media-MIME set so `.mp4` uploads route through the media upload path instead of the generic file path.
- **Source upload rejection with status `3` now hints at the per-notebook source cap** ([#977](https://github.com/ishandutta2007/open-notebooklm/pull/977)). Previously surfaced as a bare `RPCError`; the error message now suggests checking the notebook source count when the server returns the cap-rejection code.
- **Windows atomic-replace races on cookie/profile writes** ([#983](https://github.com/ishandutta2007/open-notebooklm/pull/983)). `os.replace` on Windows can transiently fail with `ERROR_ACCESS_DENIED` (5) or `ERROR_SHARING_VIOLATION` (32) when the destination is briefly held open by AV scanners or backup software. Bounded retry with backoff handles the transient cases; persistent failures still surface.
- **IO event-loop blocking and chunked-download throughput** ([#981](https://github.com/ishandutta2007/open-notebooklm/pull/981)). Sync `Path.resolve()` / `open()` / `os.fstat()` on the upload path are now wrapped in `asyncio.to_thread`, keeping the loop responsive under the upload semaphore on slow filesystems. Chunked downloads use a single dedicated writer thread fed by a bounded `queue.Queue` (≈512 KiB buffered) instead of spawning one `to_thread` call per 64 KiB chunk. A bug where `ArtifactDownloadError` (raised by `download_urls_batch()` for invalid scheme / untrusted host / auth failure / HTML payload) aborted the entire batch instead of landing in `DownloadResult.failed` is also fixed.
- **`notebooklm login --browser-cookies` hardening** ([#974](https://github.com/ishandutta2007/open-notebooklm/pull/974)). Tightened Chromium account enumeration, cookie-jar normalization, and refresh writes so partial extractions surface a clear error instead of silently writing an incomplete `storage_state.json`. Pairs with the in-memory `__Secure-1PSIDTS` recovery shipped in [#990](https://github.com/ishandutta2007/open-notebooklm/pull/990) / [#991](https://github.com/ishandutta2007/open-notebooklm/pull/991).
- **`notebooklm login --browser-cookies` Playwright account metadata** ([#989](https://github.com/ishandutta2007/open-notebooklm/pull/989)). The Playwright login path now writes account metadata to the profile and validates it on subsequent refresh (rejecting bool-shaped corruption from earlier buggy writes), so `notebooklm auth refresh --all-accounts` and `--account EMAIL` can target the right profile without manual cleanup.
- **Playwright account metadata repair runs after the sync context exits** ([#1000](https://github.com/ishandutta2007/open-notebooklm/issues/1000), [#1002](https://github.com/ishandutta2007/open-notebooklm/pull/1002)). `notebooklm login` previously invoked `repair_playwright_account_metadata()` while `sync_playwright()`'s event loop was still active, which raised on `run_async()`. The repair is now deferred until after the Playwright context closes, using the captured page HTML and saved storage path.
- **`source add-research --wait` timeout path** ([#971](https://github.com/ishandutta2007/open-notebooklm/pull/971)). The CLI service now wraps the research wait in a typed timeout error and surfaces a resumable hint (`notebooklm research poll <task_id>`) instead of hanging until the global request timeout.
- **`notebooklm auth refresh --all-accounts` language sync runs once** ([#976](https://github.com/ishandutta2007/open-notebooklm/pull/976)). Previously re-issued the `notebooklm.SetLanguage` RPC once per account; now coalesces to a single sync at the end of the multi-account loop.
- **Loop-affinity guard on `sources.add_file` and `client.drain()` admission** ([#952](https://github.com/ishandutta2007/open-notebooklm/pull/952)). Cross-event-loop reuse already failed fast on authed RPC POSTs (#633); upload admission and drain admission now also raise `RuntimeError` instead of silently mis-binding to the wrong loop.
- **`NotebookLMClient.close()` no longer leaks the httpx pool if cancelled mid-drain** ([#950](https://github.com/ishandutta2007/open-notebooklm/pull/950)). A `CancelledError` raised during drain previously skipped `httpx.AsyncClient.aclose()`; close now shields the transport cleanup so the connection pool is released on every cancellation path.
- **Deep-research source import no longer requires leaving the "Add sources?" modal** ([#315](https://github.com/ishandutta2007/open-notebooklm/issues/315), [#882](https://github.com/ishandutta2007/open-notebooklm/pull/882)). The deep-research flow used to discover sources but skip the modal-confirm step, leaving sources pending until a separate UI action committed them. The CLI / `ResearchAPI.import_sources` now commits directly.
- **`DELETE_NOTE` no longer races shielded `UPDATE_NOTE` at cancel time** ([#876](https://github.com/ishandutta2007/open-notebooklm/pull/876)). Cancellation during an in-flight `NotesAPI.update(...)` could land a delete before the shielded write completed, then have the update resurrect the note. Cancel-time cleanup is now ordered so `DELETE_NOTE` waits for any shielded `UPDATE_NOTE` to settle.
...
- **`RPCHealth` surfaces `httpx` exception class name on empty error messages** ([#874](https://github.com/ishandutta2007/open-notebooklm/pull/874)). Some `httpx` exception classes raise with empty `str(exc)`, which previously surfaced as a blank line. Health output now prefixes the class name (e.g. `ConnectTimeout:`).
...
- **Per-create-RPC idempotency hardening** ([#801](https://github.com/ishandutta2007/open-notebooklm/pull/801), [#806](https://github.com/ishandutta2007/open-notebooklm/pull/806), [#808](https://github.com/ishandutta2007/open-notebooklm/pull/808), [#809](https://github.com/ishandutta2007/open-notebooklm/pull/809), [#813](https://github.com/ishandutta2007/open-notebooklm/pull/813)). Six-policy idempotency registry with probe-then-retry semantics for `ADD_SOURCE`, `ADD_SOURCE_FILE`, `CREATE_NOTE`, `CREATE_ARTIFACT`, `GENERATE_MIND_MAP`, and `START_RESEARCH` / `IMPORT_SOURCES`. Resolves duplicate-create on transient retries while still raising clear errors for genuine probe failures.

### Security
- **Comprehensive secret-leak audit closed across logging, auth, and URL handling** ([#746](https://github.com/ishandutta2007/open-notebooklm/pull/746), [#803](https://github.com/ishandutta2007/open-notebooklm/pull/803), [#903](https://github.com/ishandutta2007/open-notebooklm/pull/903)). A multi-iteration sweep tightening every surface that could leak credentials or grant codes:
...
[Unreleased]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.8.2...HEAD
[0.8.2]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.8.1...v0.8.2
[0.8.1]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.8.0...v0.8.1
[0.8.0]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.7.3...v0.8.0
[0.7.3]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.7.2...v0.7.3
[0.7.2]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.7.1...v0.7.2
[0.7.1]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.7.0...v0.7.1
[0.7.0]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.6.0...v0.7.0
[0.6.0]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.5.0...v0.6.0
[0.5.0]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.4.1...v0.5.0
[0.4.1]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.4.0...v0.4.1
[0.4.0]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.3.4...v0.4.0
[0.3.4]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.3.3...v0.3.4
[0.3.3]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.3.2...v0.3.3
[0.3.2]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.3.1...v0.3.2
[0.3.1]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.3.0...v0.3.1
[0.3.0]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.2.1...v0.3.0
[0.2.1]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.2.0...v0.2.1
[0.2.0]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.1.4...v0.2.0
[0.1.4]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.1.3...v0.1.4
[0.1.3]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.1.2...v0.1.3
[0.1.2]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.1.1...v0.1.2
[0.1.1]: https://github.com/ishandutta2007/open-notebooklm/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/ishandutta2007/open-notebooklm/releases/tag/v0.1.0
