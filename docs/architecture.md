...
Start with the explorable [system overview](https://ishandutta2007.github.io/open-notebooklm/diagrams/01-system-overview.html).
The [adapter view](https://ishandutta2007.github.io/open-notebooklm/diagrams/02-adapters-and-app-layer.html) expands the frontend
boundary, and the [backend split](https://ishandutta2007.github.io/open-notebooklm/diagrams/06-backends-web-and-android.html) shows
...
[selection workflow](https://ishandutta2007.github.io/open-notebooklm/diagrams/28-profile-auth-backend-selection.workflow.html) for the exact
...
The [exception hierarchy](https://ishandutta2007.github.io/open-notebooklm/diagrams/09-exception-hierarchy.html) shows that shared
...
Use the [runtime and transport view](https://ishandutta2007.github.io/open-notebooklm/diagrams/03-client-runtime-and-transport.html)
for ownership, the [RPC sequence](https://ishandutta2007.github.io/open-notebooklm/diagrams/07-rpc-call-path.html) for call order, and
the [runtime class model](https://ishandutta2007.github.io/open-notebooklm/diagrams/23-runtime-class-model.html) for constructor
relationships. The [capability-contract map](https://ishandutta2007.github.io/open-notebooklm/diagrams/27-capability-contracts.html)
...
The [Android backend view](https://ishandutta2007.github.io/open-notebooklm/diagrams/14-android-backend.html) identifies its
participants, while the [Android call sequence](https://ishandutta2007.github.io/open-notebooklm/diagrams/15-android-call-path.html)
...
For a compact view, see the [chat sequence](https://ishandutta2007.github.io/open-notebooklm/diagrams/11-chat-ask-sequence.html) and
the [chat/notes class model](https://ishandutta2007.github.io/open-notebooklm/diagrams/26-chat-notes-class-model.html).
...
The [source-ingest data flow](https://ishandutta2007.github.io/open-notebooklm/diagrams/12-source-ingest-dataflow.html),
[artifact lifecycle](https://ishandutta2007.github.io/open-notebooklm/diagrams/13-artifact-lifecycle.html), and
[transfer security boundaries](https://ishandutta2007.github.io/open-notebooklm/diagrams/30-transfer-security-boundaries.dataflow.html) provide
...
The [client resource lifecycle](https://ishandutta2007.github.io/open-notebooklm/diagrams/19-client-resource-lifecycle.html) shows
open, drain, close, and rollback states. The
[retry-policy workflow](https://ishandutta2007.github.io/open-notebooklm/diagrams/20-retry-policy-workflow.html) complements the
...
The [feature-service map](https://ishandutta2007.github.io/open-notebooklm/diagrams/05-feature-services.html) is the compact index;
the [artifact class model](https://ishandutta2007.github.io/open-notebooklm/diagrams/08-artifacts-class-model.html) and
[sources class model](https://ishandutta2007.github.io/open-notebooklm/diagrams/25-sources-class-model.html) expand its two densest
resource domains. The [deep-research lifecycle](https://ishandutta2007.github.io/open-notebooklm/diagrams/21-deep-research-lifecycle.html)
and [organization/sharing map](https://ishandutta2007.github.io/open-notebooklm/diagrams/29-organization-and-sharing.architecture.html) cover the
...
[authentication architecture](https://ishandutta2007.github.io/open-notebooklm/diagrams/04-authentication.html) shows ownership,
the [login workflow](https://ishandutta2007.github.io/open-notebooklm/diagrams/10-login-workflow.html) shows credential acquisition,
and the [auth class model](https://ishandutta2007.github.io/open-notebooklm/diagrams/24-auth-class-model.html) shows the storage and
...
extraction pattern.
See the [CLI subsystem diagram](https://ishandutta2007.github.io/open-notebooklm/diagrams/16-cli-subsystem.html) for the command,
...
The [MCP subsystem diagram](https://ishandutta2007.github.io/open-notebooklm/diagrams/17-mcp-subsystem.html) shows the adapter,
...
The [REST subsystem diagram](https://ishandutta2007.github.io/open-notebooklm/diagrams/18-rest-server-subsystem.html) shows the
...
The [testing and guardrails view](https://ishandutta2007.github.io/open-notebooklm/diagrams/22-testing-and-guardrails.html) maps the
