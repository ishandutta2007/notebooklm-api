...
| Token | Meaning |
|-------|---------|
| **`#NNNN`** | A GitHub pull request or issue number in `ishandutta2007/open-notebooklm`, e.g. <https://github.com/ishandutta2007/open-notebooklm/pull/1205>. Bare numbers are not clickable in most renderers; resolve them on GitHub. |
