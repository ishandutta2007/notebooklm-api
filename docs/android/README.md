...
Start with the [Web/Android comparison](https://ishandutta2007.github.io/open-notebooklm/diagrams/06-backends-web-and-android.html), then open the
[Android subsystem](https://ishandutta2007.github.io/open-notebooklm/diagrams/14-android-backend.html) and
[call sequence](https://ishandutta2007.github.io/open-notebooklm/diagrams/15-android-call-path.html). Profile/backend precedence and
credential-scoped transfers are covered by diagrams
[28](https://ishandutta2007.github.io/open-notebooklm/diagrams/28-profile-auth-backend-selection.workflow.html) and
[30](https://ishandutta2007.github.io/open-notebooklm/diagrams/30-transfer-security-boundaries.dataflow.html).
