...
- [ ] Update comparison links at bottom of `CHANGELOG.md`:
  ```markdown
  [Unreleased]: https://github.com/ishandutta2007/open-notebooklm/compare/vX.Y.Z...HEAD
  [X.Y.Z]: https://github.com/ishandutta2007/open-notebooklm/compare/vPREV...vX.Y.Z
  ```
