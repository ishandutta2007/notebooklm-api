...
Use the [system overview](https://ishandutta2007.github.io/open-notebooklm/diagrams/01-system-overview.html) while orienting to the packages and
the [testing/guardrails map](https://ishandutta2007.github.io/open-notebooklm/diagrams/22-testing-and-guardrails.html)
...
[#2239](https://github.com/ishandutta2007/open-notebooklm/issues/2239).
...
```bash
gh api -X PUT \
  /repos/ishandutta2007/open-notebooklm/environments/protected-readonly \
  -f 'wait_timer=0' \
