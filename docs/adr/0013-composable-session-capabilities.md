...
- The `_core.py` compatibility shim was removed in Phase 4 ([#889](https://github.com/ishandutta2007/open-notebooklm/pull/889)); see `tests/_guardrails/test_public_surface_manifest.py` (search for `Tier-10 PR-A re-export identity pins for ``notebooklm._core`` were deleted`) for the removal pin.
