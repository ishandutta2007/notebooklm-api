...
| GitHub repo | → `ishandutta2007/gemini-notebook-py` (auto-redirects) |
...
1. **Repo rename first, quiet window**: rename to
   `ishandutta2007/gemini-notebook-py`; immediately re-point the Trusted-Publishing
   ...
   on any stale `github.repository` / `ishandutta2007/open-notebooklm` literal
