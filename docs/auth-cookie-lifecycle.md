...
[authentication architecture](https://ishandutta2007.github.io/open-notebooklm/diagrams/04-authentication.html), then use the
[login workflow](https://ishandutta2007.github.io/open-notebooklm/diagrams/10-login-workflow.html) and
[auth class model](https://ishandutta2007.github.io/open-notebooklm/diagrams/24-auth-class-model.html) for acquisition and storage
