"""open-notebooklm — Open-source Python SDK for Google NotebookLM / Gemini Notebook automation.
...
try:
    __version__ = version("notebooklm-api")
    ...
    try:
        ...
        _logger.debug(
            "Package 'notebooklm-api' not found in metadata. "
